...
def load_generated_captions(cap_file, image_id_key:str, caption_key:str):
    ...
    imids = [int(obj[image_id_key].replace("COCO_val2014_", "").replace(".jpg", "")) for obj in caps]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_id_key", type=str, default="image",
                        help="in each dict of cap_file, which key stores image id of coco.")
    parser.add_argument("--caption_key", type=str, default="text",
